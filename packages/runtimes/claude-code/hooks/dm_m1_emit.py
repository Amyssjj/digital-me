...
# hooks so they reach brain-host even when settings.json `env` (the usual
# carrier of DIGITAL_ME_BRAIN_URL) does not reach this process. The script's
# own dir, symlinks NOT resolved (same as the bash hooks' `dirname "$0"`).
# Module-level so --selftest can repoint it.
